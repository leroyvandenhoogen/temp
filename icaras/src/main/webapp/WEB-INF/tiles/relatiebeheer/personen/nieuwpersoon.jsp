	...
	<form:form method="POST" modelAttribute="persoon">
		<table class="details">
			...
			<tr>
				...
				<td><form:input path="tussenvoegsel" id="tussenvoegsel" value=""/></td>
			...
			<tr>
				...
				<td><form:input path="geboorteplaats" id="geboorteplaats" value=""/></td>
			...
			<tr>
				...
				<td><form:input path="rijbewijs" id="rijbewijs" value="false"/></td>
				<td><form:errors path="rijbewijs" cssClass="error" /></td>
			</tr>

			<tr>
				<td><label for="nationaliteit">Nationaliteit: </label></td>
				<td><form:input path="nationaliteit" id="nationaliteit" value="Nederland"/></td>
			...
			<th>Adresgegevens</th>
			 <c:forEach items="${persoon.adressen}" var="adres" varStatus="current" begin="0">
				...
				<tr>
					...
					<td><form:input path="adressen[${current.index}].land" value="Nederland" /></td>
				</tr>
				<tr>
