...
//	}
	...
	public void testSearchFullPersoon() {
		...
		List<Persoon> sjaakVoornaam = persoonDao.search("sjaak");
		assertTrue(sjaakVoornaam.contains(persoon1));
		
		List<Persoon> sjaakAchternaam = persoonDao.search("trekhaak");
		assertTrue(sjaakAchternaam.contains(persoon1));
		
		List<Persoon> sjaakVoornaamIncomplete = persoonDao.search("sja");
		assertTrue(sjaakVoornaamIncomplete.contains(persoon1));
		
		List<Persoon> sjaakAchternaamIncomplete = persoonDao.search("trek");
		assertTrue(sjaakAchternaamIncomplete.contains(persoon1));
		
		List<Persoon> sjaak	= persoonDao.search("sjaak trekhaak");
		assertTrue(sjaak.contains(persoon1));
		
		List<Persoon> sjaak2 = persoonDao.search("sjaak, trekhaak");
		assertTrue(sjaak2.contains(persoon1));
		
		List<Persoon> sjaak3 = persoonDao.search("sjaak,trekhaak");
		assertTrue(sjaak3.contains(persoon1));
		
		List<Persoon> sjaakIncomplete = persoonDao.search("sja trek");
		assertTrue(sjaakIncomplete.contains(persoon1));
		
		List<Persoon> sjaakIncomplete2 = persoonDao.search("s trek");
		assertTrue(sjaakIncomplete2.contains(persoon1));
		
		List<Persoon> sjaakReverse = persoonDao.search("trekhaak sjaak");
		assertTrue(sjaakReverse.contains(persoon1));
		
		List<Persoon> sjaakReverse2 = persoonDao.search("trekhaak, sjaak");
		assertTrue(sjaakReverse2.contains(persoon1));
		
		List<Persoon> sjaakReverse3 = persoonDao.search("trekhaak,sjaak");
		assertTrue(sjaakReverse3.contains(persoon1));
		
		List<Persoon> sjaakIncompleteReverse = persoonDao.search("trek sja");
